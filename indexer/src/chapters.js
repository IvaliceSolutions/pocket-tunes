// ID3v2 CHAP (chapter) reader.
//
// music-metadata surfaces CHAP start/end times but leaves the embedded
// sub-frames empty, so chapter *titles* are lost. Chapters are the whole point
// of navigating a 20 h audiobook, so parse the raw tag ourselves — it's a small
//, well-specified format (id3.org/id3v2-chapters-1.0).
//
...
/**
 * Read ID3v2 chapters from `file`.
 * Returns [{ startMs, title }] sorted by startMs, or [] when there are none.
 */
